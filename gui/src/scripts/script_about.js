...
// ## GITHUB BUTTON ## //
const githubLink = 'https://github.com/SilentGrabber0';
document.getElementById('github-link').addEventListener('click', () => {
    shell.openExternal(githubLink);
});

// ## TELEGRAM BUTTON ## //
const telegramLink = 'https://discord.com/invite/alleyesonme';
document.getElementById('telegram-link').addEventListener('click', () => {
    shell.openExternal(telegramLink);
});

document.addEventListener('DOMContentLoaded', () => {
    const url = 'https://raw.githubusercontent.com/ebadlan/abt/refs/heads/main/about';
